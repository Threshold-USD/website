...
const Features = (): JSX.Element => {
  ...
  const faq = [
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageFirstQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageSecondQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageThirdQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageFourthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageFifthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageSixthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
        <div>
          ...
          <Link
            ...
            rel="noopener noreferrer"
          >
            <span className="text-purple">TaHo</span>
          </Link>
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageSeventhQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageEighthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
        <div>
          ...
          <Link
            href="https://www.liquity.org/blog/on-price-stability-of-liquity"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="text-purple">
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageNinthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageTenthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageEleventhQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
    ...
    },
    {
      question: (
        <LazyText
          text="featuresPageThirteenthQuestion"
          className="w-40 sm:w-60 h-3.5"
        />
      ),
      answer: (
  ...
  const sideTexts: SideTextType[] = [
    {
      imageUrl:
        theme === 'light'
          ? '/trading-ethereum.svg'
          : '/dark-trading-ethereum.svg',
      imageAlt: 'trading ethereum image',
      title: (
        <LazyText
          text="featuresPageFirstFeatureTitle"
          className="h-6 w-40 sm:w-60"
        />
      ),
      description: (
        <>
          <LazyText
            text="featuresPageFirstFeatureDescription"
    ...
    {
      imageUrl: theme === 'light' ? '/laptops.svg' : '/dark-laptops.svg',
      imageAlt: 'censorship resistant',
      title: (
        <LazyText
          text="featuresPageSecondFeatureTitle"
          className="h-6 w-40 sm:w-60"
        />
      ),
      description: (
        <>
          <LazyText
            text="featuresPageSecondFeatureDescription"
            className="h-3.5 w-40 sm:w-60 lg:w-80"
            numberOfLines={5}
          />
        </>
    ...
    {
      imageUrl: theme === 'light' ? '/balance.svg' : '/dark-balance.svg',
      imageAlt: 'capital efficiency',
      title: (
        <LazyText
          text="featuresPageThirdFeatureTitle"
          className="h-6 w-40 sm:w-60"
        />
      ),
      description: (
        <>
          <LazyText
            text="featuresPageThirdFeatureDescription"
            className="h-3.5 w-40 sm:w-60 lg:w-80"
            numberOfLines={5}
          />
        </>
    ...
    <>
      ...
      <div className="flex flex-col w-full max-w-7xl px-4 sm:px-12">
        <section className="flex flex-col-reverse md:flex-row items-center mt-12 sm:mt-12 m:gap-20 px-4">
          <div className="flex flex-col items-center sm:items-start w-full text-center sm:text-left dark:text-white sm:ml-8">
            <span className="text-4xl sm:text-5xl font-bold">
              <LazyText
                text="featuresPageHeroBannerTitle"
                className="h-8 w-40 sm:w-60 lg:w-80 xl:w-104"
              />
            </span>
            <p className="mt-3 sm:text-xl font-semibold text-grey6 dark:text-grey3">
              <LazyText
                text="featuresPageHeroBannerSubtitle"
                className="h-4 w-40 sm:w-60 lg:w-80"
                numberOfLines={2}
              />
            </p>
            <div className="flex gap-4 sm:gap-8 mt-10">
              <Link href="https://app.thresholdusd.org">
                <button className="flex items-center gap-2 bg-purple text-white text-xs sm:text-sm font-semibold rounded-full px-12 h-11">
                  ...
                  <span className="flex items-center justify-center">
                    <LazyText
                      text="featuresPageHeroBannerButton"
          ...
          <div className="flex justify-center items-center w-full">
            <div className="relative w-[20rem] h-[18rem] sm:w-[29.5rem] sm:h-[29.5rem]">
              <Image
                src={
                  theme === 'light' ? '/herobanner.svg' : '/dark-herobanner.svg'
                }
        ...
        <section className="flex flex-col items-start gap-16 sm:gap-40 mt-20 sm:mt-36">
          {sideTexts.map(({ ...sideTexts }, index) => {
            return <SideText key={index} {...sideTexts} />;
          })}
        </section>
        <section className="flex flex-col items-center justify-center px-2 sm:px-0 mt-28 sm:mt-52 w-full">
          <span className="text-2xl sm:text-4xl font-semibold text-center sm:text-left dark:text-white">
            <LazyText
              text="featuresPageResourcesComponentTitle"
              className="h-8 w-40 sm:w-60 lg:w-80 xl:w-100"
            />
          </span>
          <p className="text-grey text-center font-medium sm:font-semibold text-sm sm:text-lg mt-4 max-w-2xl dark:text-grey3">
            <LazyText
              text="featuresPageResourcesSubtitleFirstSentence"
              className="h-4 w-40 sm:w-60 lg:w-80"
            />
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mt-12 sm:mt-20">
            <div className="flex flex-col items-center sm:items-start gap-2 max-w-xs">
              ...
              <span className="text-center font-bold text-lg mt-2 dark:text-white">
                <LazyText
                  text="featuresPageFirstResourceTitle"
                  className="h-4 w-40 sm:w-60"
                />
              </span>
              <p className="text-grey text-sm sm:text-base font-medium text-center sm:text-left dark:text-grey3">
                <LazyText
                  text="featuresPageFirstResourceDescription"
                  className="h-3.5 w-40 sm:w-60 lg:w-80"
                  numberOfLines={2}
                />
                <br />
                ...
                >
                  <span className="text-purple font-semibold text-sm sm:text-base">
                    <LazyText
                      text="featuresPageResourcesCallToAction"
            ...
            <div className="flex flex-col items-center sm:items-start gap-2 max-w-xs">
              ...
              <span className="text-center font-bold text-lg mt-2 dark:text-white">
                <LazyText
                  text="featuresPageSecondResourceTitle"
                  className="h-4 w-40 sm:w-48"
                />
              </span>
              <p className="text-grey text-sm sm:text-base font-medium text-center sm:text-left dark:text-grey3">
                <LazyText
                  text="featuresPageSecondResourceDescription"
                  className="h-3.5 w-40 sm:w-60 lg:w-80"
                  numberOfLines={2}
                />
                <br />
            ...
            <div className="flex flex-col items-center sm:items-start gap-2 max-w-xs">
              ...
              <span className="text-center font-bold text-lg mt-2 dark:text-white">
                <LazyText
                  text="featuresPageThirdResourceTitle"
                  className="h-4 w-28"
                />
              </span>
              <p className="text-grey text-sm sm:text-base font-medium text-center sm:text-left dark:text-grey3">
                <LazyText
                  text="featuresPageThirdResourceDescription"
                  className="h-3.5 w-40 sm:w-60 lg:w-80"
                  numberOfLines={2}
                />
                <br />
                <br />
                <Link
                  href="https://dashboard.threshold.network/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span className="text-purple font-semibold text-sm sm:text-base">
        ...
        <section
          className="flex flex-col items-center sm:items-start justify-center sm:justify-start mt-24 sm:mt-52 mb-16 sm:mb-40 w-full px-4 sm:px-16"
          id="faq"
        >
          <span className="text-2xl sm:text-45xl font-bold text-center sm:text-left dark:text-white">
            <LazyText
              text="featuresPageFaqComponentTitle"
              className="h-8 w-40 sm:w-60 lg:w-80 xl:w-96"
            />
          </span>
