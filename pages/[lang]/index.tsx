...
const queryCollateralsData = async (collateral: any) => {
  ...
  for (const collateralVersion of collateral.subfolders) {
    ...
    for (const network of networks) {
      ...
      const queriedCollateralData = await queryGraph(query, thresholdUrlByNetwork).catch((e) => console.log(e))
    ...
    <>
      ...
      <div className="flex flex-col w-full max-w-5xl px-6 sm:px-12">    
        <section className='flex flex-col items-center justify-center gap-4 mt-32'>
          <h1 className="max-w-4xl text-center">
            <LazyText text="heroBannerTitle" className="h-16 w-56 sm:w-96 -mt-4" />
          </h1>
          <LazyText className="h-12 w-40 sm:w-56" />
          <p className="text-center mt-4 sm:text-lg font-semibold text-grey">
            <LazyText text="heroBannerFirstSubTitle" className="mt-2 h-4 w-40 sm:w-56" />
            <br/>
            <LazyText text="heroBannerSecondSubTitle" className="mb-2 h-4 w-20 sm:w-80" />
          </p>
        ...
        <section className='flex justify-center mt-24'>
          <div className="flex shadow-lg rounded-2xl mx-12">
            ...
            <div className="hidden lg:flex flex-col items-center gap-1 px-20 py-6 w-80">
              ...
              <span className="text-3xl font-bold text-blue1">
                {numberOfOpenedVaults?.prettify(0) ?? <LazyText text="loading" />}
              </span>
              <span className="text-xs font-semibold text-grey3">
                <LazyText text="cardsBelow" />
              </span>
            ...
            <div className='flex items-center gap-2 justify-center'>
              <span className="text-3xl font-bold text-blue1">
                {tvlInEth?.prettify(2) ? `$${tvlInEth?.prettify(2)}` : <LazyText text="loading" />}
              </span>
            </div>
              <span className="text-xs font-semibold text-grey3">
                <LazyText text="cardsBelow" />
        ...
        <section className='flex flex-col md:flex-row gap-12 sm:gap-20 md:gap-0 justify-center mt-32 sm:mt-40'>
          <div className="flex flex-col gap-4 text-left w-full">
            <span className="text-2xl text-center sm:text-left">
              <LazyText text="featuresComponentTitle" className="w-full sm:w-80 h-3.5"  />
            </span>
            <span className="text-sm text-center sm:text-left">
              <LazyText text="featuresComponentSubTitle" className="w-full sm:w-96 h-3.5"  />
            </span>
            <div className="flex items-start gap-3 mt-4">
              ...
              <div className="flex flex-col gap-2">
                <span className="font-bold">
                  <LazyText text="firstFeatureTitle" className="w-full sm:w-96 h-3.5"  />
                </span>
                <span className="text-xs text-grey4 font-medium pr-20">
                  <LazyText text="firstFeatureDescription" className="w-full sm:w-96 h-3.5" numberOfLines={2} />
                </span>
              </div>
            </div>
            <div className="flex items-start gap-3 mt-3">
              ...
              <div className="flex flex-col gap-2">
                <span className="font-bold">
                  <LazyText text="secondFeatureTitle" className="w-full sm:w-44 h-3.5" />
                </span>
                <span className="text-xs text-grey4 font-medium pr-20">
                  <LazyText text="secondFeatureDescription" className="w-full sm:w-80 h-3.5" numberOfLines={2} />
                </span>
              </div>
            </div>
            <div className="flex items-start gap-3 mt-3">
              ...
              <div className="flex flex-col gap-2">
                <span className="font-bold">
                  <LazyText text="thirdFeatureTitle" className="w-full sm:w-40 h-3.5" />
                </span>
                <span className="text-xs text-grey4 font-medium pr-20">
                  <LazyText text="thirdFeatureDescription" className="w-full sm:w-96 h-3.5" numberOfLines={2} />
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-col w-full max-w-7xl px-12 lg:px-20">
        <section className="flex flex-col mt-24 sm:mt-36">
          <h2>
            <LazyText text="highlightsComponentTitle" className="w-full sm:w-96 h-8" />
          </h2>
          <p className="text-grey font-medium sm:text-lg mt-6">
            <LazyText text="highlightsComponentSubTitle" className="w-full h-4" numberOfLines={2} />
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 sm:gap-4 mt-12">
            <div className="flex flex-col gap-2 max-w-xs">
              ...
              <p className="text-grey text-sm font-medium">
                <LazyText text="firstHighlightDescriptionFirstParagraph" className="w-full h-3.5" numberOfLines={3} />
                <br/><br/>
                <LazyText text="firstHighlightDescriptionSecondParagraph" className="w-full h-3.5" numberOfLines={3} />
              </p>
            </div>
            <div className="flex flex-col gap-2 max-w-xs">
              <div className="relative w-14 h-14">
              ...
              <p className="text-grey text-sm font-medium">
                <LazyText text="secondHighlightDescriptionFirstParagraph" className="w-full h-3.5" numberOfLines={3} />
                <br/><br/> 
                <LazyText text="secondHighlightDescriptionSecondParagraph" className="w-full h-3.5" numberOfLines={3} />
              </p>
            </div>
            <div className="flex flex-col gap-2 max-w-xs">
              <div className="relative w-14 h-14">
              ...
              <p className="text-grey text-sm font-medium">
                <LazyText text="thirdHighlightDescriptionFirstParagraph" className="w-full h-3.5" numberOfLines={3} />
                <br/><br/>
                <LazyText text="thirdHighlightDescriptionSecondParagraph" className="w-full h-3.5" numberOfLines={3} />
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="flex flex-col mt-24 sm:mt-40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-4 mt-12 sm:mt-5">
            <div className="flex flex-col gap-3 max-w-sm">
              ...
              <p className="font-medium text-sm text-grey leading-6">
                <LazyText text="firstAnswer" className="w-full h-3.5" numberOfLines={5} />
              </p>
            </div>
            <div className="flex flex-col gap-3 max-w-sm">
              <div className="relative w-7 h-7">
              ...
              <p className="font-medium text-sm text-grey leading-6">
                <LazyText text="secondAnswerFirstParagraph" className="w-full h-3.5" />
                <LazyText className="w-20 h-3.5" />
                <br/>
                <br/>
                <LazyText text="secondAnswerFirstPoint" className="w-full h-3.5" />
                <br/>
                <LazyText text="secondAnswerSecondPoint" className="w-full h-3.5" />
                <br/>
                <LazyText text="secondAnswerThirdPoint" className="w-full h-3.5" />
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-4 mt-9">
            <div className="flex flex-col gap-3 max-w-sm">
              ...
              <p className="font-medium text-sm text-grey leading-6">
                <LazyText text="thirdAnswerFirstParagraph" className="w-full h-3.5" numberOfLines={4} />
                <br/>
                <br/>
                <LazyText text="thirdAnswerSecondParagraph" className="w-full h-3.5" numberOfLines={3} />
              </p>
            </div>
            <div className="flex flex-col gap-3 max-w-sm">
              <div className="relative w-7 h-7">
              ...
              <p className="font-medium text-sm text-grey leading-6">
                <LazyText text="fourthAnswerFirstSentence" className="w-full h-3.5" />
                <Link href="https://docs.threshold.network/applications/threshold-usd" target="_blank">
                  <span className="text-blue">
                  <LazyText text="fourthAnswerSecondSentence" className="w-20 h-3.5" />
                  </span>
                </Link>
                <br/>
                <LazyText text="fourthAnswerThirdSentence" className="w-full h-3.5" />
                <Link href="https://app.thresholdusd.org" target="_blank">
                  <span className="text-blue">
                  <LazyText text="fourthAnswerFourthSentence" className="w-20 h-3.5" />
                  </span>
                </Link>
                <br/><br/>
                <LazyText text="fourthAnswerFifthSentence" className="w-full h-3.5" />
          ...
          <div className="flex flex-col gap-3 max-w-sm mt-16">
            ...
            <p className="font-medium text-sm text-grey leading-6">
              <LazyText text="frequentAskedQuestionCTADescriptionFirstSentence" className="w-full h-3.5" />
              <Link href="/features/#faq">
                <span className="text-blue">
                <LazyText text="frequentAskedQuestionCTADescriptionSecondSentence" className="w-20 h-3.5" />
                </span>
              </Link>
            </p>
          </div>
      ...
      <div className="flex flex-col w-full max-w-7xl px-12">
        <section className='flex flex-col items-center mt-20 sm:mt-36 mb-8 sm:mb-28'>
          <span className="text-3xl sm:text-5xl font-bold text-center sm:text-left">
            <LazyText text="socialCTATitle" className="w-40 sm:w-60 h-8" />
          </span>
          <p className="text-center text-grey font-medium mt-6 sm:mt-2 text-sm sm:text-base sm:px-69.5">
